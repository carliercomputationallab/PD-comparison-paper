# -*- coding: utf-8 -*-
"""
Created on Tue Feb 13 14:42:07 2024
...
def calculate_penalty(x):
    ...
    for param in x[4:7]:
        if param < 0:
            penalty.append(param ** 2)
            
        elif param > 1:
            penalty.append((param-1)**2)
...
mtac = pd.read_excel('fittedPS/fittedPS_UGM.xlsx', index_col = 0)
...
with pd.ExcelWriter('fittedPS/sse_UGM.xlsx', engine='openpyxl') as writer:
    sse.to_excel(writer)