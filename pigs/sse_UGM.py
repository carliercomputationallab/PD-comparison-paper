# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 15:37:53 2023
...
def calculate_penalty(x):
    penalty = [0] * 5
    for i, param in enumerate(x[6:11]):
        if param < 0:
            penalty[i] = param ** 2
...
# with pd.ExcelWriter('fittedPS/predicted_cd_Graff.xlsx', engine='openpyxl') as writer:
