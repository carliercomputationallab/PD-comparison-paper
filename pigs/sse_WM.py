# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 13:59:32 2023
...
for k,pfile in enumerate(patientlist):  
    ...
    for j, solute in enumerate(solutes):
        ...
        # plt.show()
         ...
         #the value of predicted cd0 comes from the initial guess
    ...
    # with pd.ExcelWriter('fittedPS/predicted_cd_Waniewski.xlsx', engine='openpyxl') as writer:
